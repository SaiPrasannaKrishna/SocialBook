...
module.exports = "<nav class=\"navbar justify-content-between\">\n  <a class=\"navbar-brand\">Social Book</a>\n  <form class=\"form-inline\" #f=\"ngForm\" (ngSubmit)=\"login(f)\">\n    <input \n      class=\"form-control mr-sm-2\" \n      type=\"search\" \n      placeholder=\"Username\" \n      aria-label=\"Search\"\n      id=\"username\" \n      name=\"username\"\n      required \n      ngModel \n      #username = \"ngModel\">\n    <input \n      class=\"form-control mr-sm-2\" \n      type=\"search\"\n      placeholder=\"Password\" \n      aria-label=\"Search\"\n      id=\"password\"\n      name=\"password\"\n      required\n      ngModel\n      #password=\"ngModel\">\n    <button class=\"btn my-2 my-sm-0\"  [disabled]=\"!f.valid\">login</button>\n  </form>\n</nav>\n\n<app-register></app-register>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_route, _feedService) {
        this._route = _route;
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_feed_service__WEBPACK_IMPORTED_MODULE_2__["FeedService"]])
    ], LoginComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _login_routing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login.routing.module */ "./src/app/views/login/login.routing.module.ts");
...
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../register/register.component */ "./src/app/views/register/register.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _services_feed_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/feed.service */ "./src/app/services/feed.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginModule = /** @class */ (function () {
    ...
    LoginModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_login_routing_module__WEBPACK_IMPORTED_MODULE_1__["LoginRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]
            ],
            declarations: [_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_3__["RegisterComponent"]],
            providers: [_services_feed_service__WEBPACK_IMPORTED_MODULE_5__["FeedService"]]
        })
    ], LoginModule);
    return LoginModule;
}());
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _login_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.component */ "./src/app/views/login/login.component.ts");
/* harmony import */ var _services_authGuard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/authGuard */ "./src/app/services/authGuard.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    },
    {
        ...
        canActivate: [_services_authGuard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }
];
...
module.exports = ".register-backgrnd{\r\n    background:#edf0f5;\r\n    min-height: 90%;\r\n}\r\n.register-backgrnd h2{\r\n    font-family: 'Freight Sans Bold', Helvetica, Arial, sans-serif !important;\r\n    font-weight: bold !important;\r\n    letter-spacing: normal;\r\n    text-rendering: optimizelegibility;\r\n    padding: 42px 0 24px;\r\n    font-size: 28px;\r\n    line-height: 36px;\r\n    color: #525252;\r\n}\r\n.list-group-item{\r\n    background:#edf0f5;\r\n    border: none;\r\n    font-size: 18px;\r\n}\r\n.sign-up{\r\n    width:25%;\r\n}\r\n.ng-touched .ng-invalid\r\n{\r\n    border:2px solid red;\r\n}"
...
module.exports = "<div class=\"row register-backgrnd\">\n  <div class=\"col-md-2 col-lg-2 col-xs-2\">\n  </div>\n  <div class=\"col-md-4 col-lg-4 col-xs-4\">\n    <div class=\"introduction\">\n      <h2>Social Books help people connect the world</h2>\n      <ul class=\"list-group\">\n          <li class=\"list-group-item\"><b>See Photos</b> and more and more and more</li>\n          <li class=\"list-group-item\"><b>See Videos</b> and more and more and more</li>\n          <li class=\"list-group-item\"><b>See Content</b> and more and more and more</li>\n        </ul>\n    </div>\n  </div>\n  <div class=\"col-md-6 col-lg-6 col-xs-6\">\n    <div class=\"introduction\">\n      <h2>Sign Up</h2>\n      <form #f=\"ngForm\" ngSubmit=\"register(f)\">\n        <div class=\"form-group\">\n          <div class=\"row\">\n            <div class=\"col-md-4 col-lg-4\">\n              <input type=\"text\" \n                     class=\"form-control\" \n                     placeholder=\"FirstName\"\n                     id=\"firstName\"\n                     name=\"firstName\"\n                     ngModel \n                     #firstName=\"ngModel\"\n                     required>\n            </div>\n            <div class=\"col-md-4 col-lg-4\">\n                <input type=\"text\" \n                       class=\"form-control\" \n                       placeholder=\"LastName\"\n                       id=\"lastName\"\n                       name=\"lastName\"\n                       ngModel \n                       #lastName=\"ngModel\"\n                       required                       \n                       >\n              </div>\n          </div><br/>\n          <div class=\"row\">\n              <div class=\"col-md-8 col-lg-8\">\n                <input type=\"text\" \n                      class=\"form-control\" \n                      placeholder=\"Email or Phone\"\n                      id=\"phone\"\n                      name=\"phone\"\n                      ngModel \n                      required\n                      #phone=\"ngModel\">\n              </div>\n            </div><br/>\n            <div class=\"row\">\n                <div class=\"col-md-8 col-lg-8\">\n                  <input type=\"text\" \n                        class=\"form-control\" \n                        placeholder=\"Password\"\n                        id=\"password\"\n                        name=\"password\"\n                        ngModel \n                        required\n                        #password=\"ngModel\">\n                </div>\n            </div><br/>\n            <label for=\"birthday\">Birthday</label>\n            <div class=\"row\">\n                <div class=\"col-md-3 col-lg-3\">\n                    <select class=\"form-control\" id=\"birthday\">\n                      <option>1</option>\n                      <option>2</option>\n                      <option>3</option>\n                      <option>4</option>\n                      <option>5</option>\n                    </select>\n                </div>\n                <div class=\"col-md-2 col-lg-2\">\n                    <select class=\"form-control\" id=\"birthday\">\n                      <option>Jan</option>\n                      <option>Feb</option>\n                      <option>Mar</option>\n                      <option>Apr</option>\n                      <option>Jun</option>\n                    </select>\n                </div>\n                <div class=\"col-md-3 col-lg-3\">\n                    <select class=\"form-control\" id=\"birthday\">\n                      <option>2011</option>\n                      <option>2012</option>\n                      <option>2013</option>\n                      <option>2014</option>\n                      <option>2015</option>\n                    </select>\n                </div>\n            </div><br/>\n            <div class=\"row\">\n              <div class=\"col-md-12 col-lg-12\">\n                <div class=\"form-check form-check-inline\">\n                    <input class=\"form-check-input\" type=\"radio\" name=\"inlineRadioOptions\" id=\"inlineRadio1\" value=\"option1\">\n                    <label class=\"form-check-label\" for=\"inlineRadio1\">Female</label>\n                  </div>\n                  <div class=\"form-check form-check-inline\">\n                    <input class=\"form-check-input\" type=\"radio\" name=\"inlineRadioOptions\" id=\"inlineRadio2\" value=\"option2\">\n                    <label class=\"form-check-label\" for=\"inlineRadio2\">Male</label>\n                  </div></div>\n            </div><br/>\n            <p style=\"font-size:12px;\">By Clicking signup,you agree to the Terms and conditions</p>\n            <div class=\"row\">\n              <div class=\"col-md-12 col-lg-12\">\n              <button class=\"btn btn-success sign-up\"\n              [disabled] =\"!f.valid\">Signup</button></div>\n            </div>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>"
