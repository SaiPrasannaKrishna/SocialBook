...
/***/ "./src/app/services/feedData.ts":
/*!**************************************!*\
  !*** ./src/app/services/feedData.ts ***!
  \**************************************/
/*! exports provided: feedDataList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "feedDataList", function() { return feedDataList; });
var feedDataList = [
    {
        "albumId": 1,
        "id": 1,
...
/* harmony import */ var _services_feedData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/feedData */ "./src/app/services/feedData.ts");
...
var ContentComponent = /** @class */ (function () {
    function ContentComponent(_feedService) {
        this._feedService = _feedService;
        this.feedList = _services_feedData__WEBPACK_IMPORTED_MODULE_2__["feedDataList"];
    }
    ...
    ContentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./content.component.css */ "./src/app/views/content/content.component.css")],
            providers: [_services_feed_service__WEBPACK_IMPORTED_MODULE_1__["FeedService"]]
        }),
...
/***/ "./src/app/views/directives/auto-complete.directive.ts":
/*!*************************************************************!*\
  !*** ./src/app/views/directives/auto-complete.directive.ts ***!
  \*************************************************************/
...
var AutoCompleteDirective = /** @class */ (function () {
    function AutoCompleteDirective(el, zone) {
        this.el = el;
        this.zone = zone;
        this.onPress = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
    AutoCompleteDirective.prototype.onkeypress = function () {
        console.log(this.el.nativeElement.value);
        this.onPress.emit(this.el.nativeElement.value);
    };
    AutoCompleteDirective.prototype.onblur = function () {
        this.onPress.emit('remove');
    };
    AutoCompleteDirective.prototype.highlight = function (color) {
        this.el.nativeElement.style.backgroundColor = color;
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], AutoCompleteDirective.prototype, "onPress", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["HostListener"])('keypress'),
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], AutoCompleteDirective.prototype, "onblur", null);
...
module.exports = "\n<nav class=\"navbar navbar-expand-lg navbar-dark fixed-top \">\n    <a class=\"navbar-brand\">SB</a>\n    <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarText\" aria-controls=\"navbarText\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n      <span class=\"navbar-toggler-icon\"></span>\n    </button>\n    <div class=\"collapse navbar-collapse\" id=\"navbarText\">\n      <ul class=\"navbar-nav mr-auto\" style=\"width:100%;\">\n        <li class=\"nav-item\" style=\"width:55%;position: relative;\">\n            <input type=\"text\" class=\"form-control search\" placeholder=\"search\" appAutoComplete\n            (onPress)=\"setFilter($event)\"/>\n            <ul *ngIf=\"!!feedDataTitles\"\n            class=\"list-group\"\n            style=\"position:fixed;background:white;width:100%;position: absolute;\">\n              <li  class=\"list-group-item\" *ngFor=\"let item of feedDataTitles\">\n                <img src={{item.url}} class=\"thumbnail-img img-responsive\"/>\n                {{item.title}}</li>\n            </ul>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\"><b>Profile</b></a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\"><b>Home</b></a>\n        </li>\n        <li class=\"nav-item\" style=\"border:none;\">\n            <a class=\"nav-link\" ><b><fa name=\"comments\" style=\"color:#041738;\" size=\"2x\"></fa></b></a>\n          </li>\n        <li class=\"nav-item\" style=\"border:none;\">\n            <a class=\"nav-link\" ><b><fa name=\"users\" style=\"color:#041738;\" size=\"2x\"></fa></b></a>\n        </li>\n        <li class=\"nav-item\" style=\"border:none;\">\n            <a class=\"nav-link\" ><b><fa name=\"bell\" style=\"color:#041738;\" size=\"2x\"></fa></b></a>\n        </li>\n        <li class=\"nav-item\" style=\"border:none;\">\n            <a class=\"nav-link\" ><b><fa name=\"question-circle\" style=\"color:#041738;\" size=\"2x\"></fa></b></a>\n        </li>\n        <li class=\"nav-item dropdown\" style=\"border:none;color:black ;\">\n            <a class=\"nav-link dropdown-toggle\" href=\"#\"\n            id=\"navbarDropdown\" role=\"button\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n            <b></b></a>\n            <div class=\"dropdown-menu\" style=\"background: #29487d\"\n            aria-labelledby=\"navbarDropdown\">\n                <a class=\"dropdown-item\">settings</a>\n                <a class=\"dropdown-item\">privacy</a>\n                <div class=\"dropdown-divider\"></div>\n                <a class=\"dropdown-item\" (click)=\"logout()\">logout</a>\n              </div>\n        </li>\n      </ul>\n    </div>\n  </nav><br/><br/><br/>\n  <app-content></app-content>"
...
/* harmony import */ var _services_feedData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/feedData */ "./src/app/services/feedData.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_feedService, _router, zone) {
        this._feedService = _feedService;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        this._feedService.currentMessage.subscribe(function (d) {
            console.log(d);
        });
    };
    HomeComponent.prototype.setFilter = function (value) {
        var _this = this;
        if (value.indexOf('remove') === -1) {
            this.zone.run(function () {
                _this.feedDataTitles = _services_feedData__WEBPACK_IMPORTED_MODULE_3__["feedDataList"];
                _this.feedDataTitles = _this.feedDataTitles.filter(function (t) {
                    return t.title.toLowerCase().indexOf(value.toLowerCase()) >= 0;
                });
                _this.filterItem = value;
                console.log(_this.filterItem);
            });
        }
        else {
            this.feedDataTitles = null;
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_feed_service__WEBPACK_IMPORTED_MODULE_1__["FeedService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"]])
    ], HomeComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _home_route_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home.route.module */ "./src/app/views/home/home.route.module.ts");
...
/* harmony import */ var _content_content_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../content/content.component */ "./src/app/views/content/content.component.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _services_feed_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/feed.service */ "./src/app/services/feed.service.ts");
/* harmony import */ var _directives_auto_complete_directive__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../directives/auto-complete.directive */ "./src/app/views/directives/auto-complete.directive.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeModule = /** @class */ (function () {
    ...
    HomeModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_home_route_module__WEBPACK_IMPORTED_MODULE_1__["HomeRouteModule"], angular_font_awesome__WEBPACK_IMPORTED_MODULE_3__["AngularFontAwesomeModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["CommonModule"]],
            declarations: [_home_component__WEBPACK_IMPORTED_MODULE_2__["HomeComponent"], _content_content_component__WEBPACK_IMPORTED_MODULE_4__["ContentComponent"], _directives_auto_complete_directive__WEBPACK_IMPORTED_MODULE_8__["AutoCompleteDirective"]],
            providers: [_services_feed_service__WEBPACK_IMPORTED_MODULE_7__["FeedService"]]
        })
    ], HomeModule);
    return HomeModule;
}());
...
/***/ "./src/app/views/home/home.route.module.ts":
/*!*************************************************!*\
  !*** ./src/app/views/home/home.route.module.ts ***!
  \*************************************************/
/*! exports provided: HomeRouteModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HomeRouteModule", function() { return HomeRouteModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var HomeRouteModule = /** @class */ (function () {
